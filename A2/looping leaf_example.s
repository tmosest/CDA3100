...
loop:	la	$a0, greq		# request value of g (0 to exit)
	li	$v0, 4
	syscall

	li	$v0, 5			# read value of g (0 to exit)
	syscall

	beq	$v0, $zero, quit	# if 0 entered, terminate
...
quit:	la	$a0, cr			# display closing
	...
	.data
intro:	.asciiz "Loop version of leaf_example tester\n"
greq:	.asciiz	"\nWhat is the value of g (0 to quit)? "
...
cr:	.asciiz	"Thanks for testing my code!\n"
